...
- Percentual do indexador configurável (ex: 110% do CDI)
...
- Taxas armazenadas localmente em JSON — sem chamadas repetidas à API
...
app/
  ...
  repositories/   # persistência em JSON (aplicações e taxas)
